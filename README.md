...
- **cargo embed**  
  _Step 1_ - Install [`cargo embed`](https://github.com/probe-rs/probe-rs/blob/master/cargo-embed):
...
- **probe-rs-cli**  
  _Step 1_ - Install [`probe-rs-cli`](https://crates.io/crates/probe-rs-cli):
